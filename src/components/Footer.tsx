        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-8 sm:grid-cols-4">
            <div className="mb-6 md:mb-0 flex flex-col align-middle items-center sm:items-start">
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="https://github.com/themesberg/flowbite" className="hover:underline ">WIKI</a>
                    </li>
                    <li>
                        <a href="https://edittraxnft.on.fleek.co/" className="hover:underline">Website</a>
                    </li>
                </ul>
            </div>
            <div className="mb-6 md:mb-0 flex flex-col align-middle items-center sm:items-start">
            ...
            <ul className="text-gray-600 dark:text-gray-400">
                <li className="mb-4">
                    <a href="https://www.figma.com/proto/3nCbiV2YWZC8nz0820lStQ/EDITTRAX-Deck-2022?page-id=0%3A1&node-id=1%3A326&viewport=528%2C428%2C0.03&scaling=scale-down" target="_blank" className="hover:underline">Handbook</a>
                </li>
                <li className="mb-4">
                    <a href="https://docs.google.com/forms/d/1GIY4O4xvrsbwUDKSiFzEXJ8Lxv4MSG7TmhZY6FvKcrI/edit" target="_blank" className="hover:underline">Checklist</a>
                </li>
            </ul>
            </div>
            <div className="mb-6 md:mb-0 flex flex-col align-middle items-center sm:items-start">
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                <li className="mb-4">
                        <a href="https://twitter.com/edittrax" target="_blank" className="hover:underline ">Twitter</a>
                    </li>
                    <li>
                        <a href="https://discord.gg/4eeurUVvTy" target="_blank" className="hover:underline">Spatial</a>
                    </li>
                </ul>
            </div>
            <div className="mb-6 md:mb-0 flex flex-col align-middle items-center sm:items-start">
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="mailto:bryanballi@gmail.com" target="_blank" className="hover:underline ">Email</a>
                    </li>
                    <li className="mb-4">
                        <a href="https://calendly.com/bai-ee/30min?month=2022-10" target="_blank" className="hover:underline ">Calendly</a>
                    </li>
                </ul>
            </div>
        </div>
