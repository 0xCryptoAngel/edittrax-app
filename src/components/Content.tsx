    ...
    <section className="bg-yellow-75 flex flex-col items-center gap-0 px-14 py-14 mb-0 mx-4 md:mb-0 md:pb-0 md:mx-0" >
      <div className="flex flex-col items-center gap-8 md:flex-row md:gap-8">
        ...
        <div className="flex flex-col items-center md:items-start md:justify-end md:h-full">
          ...
          <div className="font-mathias mt-4 text-2xl text-black text-center" >"{props.titleHardCode}"</div>
      ...
      <div className="bg-lightblue py-4 px-4 mb-11">
        <div className="mx-auto max-w-6xl gap-16 flex flex-col md:flex-row">
          <dl className="w-full md:w-2/3">
            <h2 className="text-center sm:text-left font-mathias w-full md:w-1/3 text-3xl font-extrabold leading-9">Edit & Download</h2>
            <div className="text-md space-y-4">
              ...
              <h2 className="font-mathias mr-8 mt-12 w-full md:w-1/3 text-3xl font-extrabold leading-9">Metadata</h2>
          ...
          <dl className="w-full md:w-2/3">
            ...
            <h2 className="font-mathias mr-8 mt-16 md:mt-0 w-full md:w-1/3 text-3xl font-extrabold leading-9">Rights</h2>
            <dt className="mb-4">
              <h3 className="mt-2 text-xl font-semibold">
                Collect to unlock high fidelity downloads (.wav) files.
              </h3>
