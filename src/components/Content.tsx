    ...
    <div className="bg-lightblue py-4 px-0 mb-0">
      <div className="mx-auto max-w-6xl gap-0 sm:gap-16 flex flex-col md:flex-row sm:mt-10">
        <dl className="w-full md:w-2/3">
          <h2 className=" font-mathias mr-8 md:mt-0 w-full text-lg text-2xl sm:text-2xl lg:text-4xl xl:text-4xl font-extrabold align-middle mb-6">
            <a href="https://objkt.com/asset/hicetnunc/612561" className="outline_button text-center px-4 py-4 mt-8 text-black rounded-md hover:opacity-50 mb-6">
              EDIT 
            </a>
            &nbsp; The Track 
          </h2>
          ...
          <h2 className="font-mathias mr-8 md:mt-0 w-full text-2xl sm:text-2xl lg:text-4xl xl:text-4xl font-extrabold align-middle mb-0">
            <button className="bg-orange-900 text-center px-4 py-4 mt-0 text-yellow-75 rounded-md hover:opacity-50 mb-12 drop-shadow-md" onClick={()=> {setShow(true); disableScroll();}}>
            Connect 
            </button>
            &nbsp; To Download
          </h2>
          ...
          <dd className="mb-8">
            ...
            <blockquote className="p-4 my-4 bg-yellow-75 border-l-4 border-black dark:border-gray-500 dark:bg-gray-800 text-justify">    
              <p>
        ...
        <h2 className="font-mathias mr-8 mb-0 sm:mt-6 md:mt-0 w-full text-lg sm:text-lg lg:text-xl xl:text-3xl font-extrabold align-middle mb-12">
          ...
          { 
            ...
            <button className="rounded-3xl text-black px-0 py-0 text-xs gap-y-1.5 ml-2 mt-2 outline_button uppercase" key={i}>{item}</button>
            )
          }
          </div>
        </h2>
